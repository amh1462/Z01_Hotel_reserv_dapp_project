...
window.onload = function(){
	// 예약자가 취소버튼을 눌렀을 때
	document.getElementsByClassName('userCancel').onclick = function(){
		// 먼저 메타마스크 설치 여부 확인
		...
		var userCancelBtn = document.getElementsByClassName('userCancel');
...
function calculateCancel(hotelid){
	...
	$.ajax({
		url: 'userReservConfirm?hotelid='+ hotelid,
		async: false,
		success: function(data, statusTxt, xhr){
			// cancelfee 정보
