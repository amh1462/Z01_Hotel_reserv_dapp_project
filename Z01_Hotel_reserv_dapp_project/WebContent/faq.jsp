    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="hotelinfo.html">호텔 정보</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="registerRoom.html">방 등록</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="bookstatus.html">예약 현황</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="payadjust.html">요금 정산</a>
          </li>
          <li>
