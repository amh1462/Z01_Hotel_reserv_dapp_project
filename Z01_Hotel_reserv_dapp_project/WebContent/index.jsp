	...
	<div class="bg-img">
		<div>
			<div style="height: 200px;">
				<h1 style=" font-family: ansangsu-bold; font-size: 150px; color: white; "> HotelNara </h1>
			</div>
			<div class="wrap-moveMain" onclick="navigator1()">
				<div class="wrap-moveMain-page">
					<img src="css/users.png" height="180" width="180">
			...
			<div class="wrap-moveMain" onclick="navigator2()">
				<div class="wrap-moveMain-page">
					<img src="css/hotel.png" height="180" width="180">
